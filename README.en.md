...
![Architecture: the board runs the runtime, the development host runs the simulator](docs/assets/architecture.en.svg)
...
![K1 against K3](docs/assets/board-comparison.en.svg)

## Measurements

![One tick of the control loop](docs/assets/tick-budget.en.svg)
...
![Pipeline: train, export, publish, load, verify](docs/assets/pipeline.en.svg)
